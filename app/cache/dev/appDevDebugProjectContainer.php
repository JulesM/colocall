...
class appDevDebugProjectContainer extends Container
{
     ...
     * This method always returns the same instance of the service.
     *
     * @return EntityManager512e95a7e1b09_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager A EntityManager512e95a7e1b09_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager instance.
     */
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once '/Applications/MAMP/htdocs/Colocall/app/cache/dev/jms_diextra/doctrine/EntityManager_512e95a7e1b09.php';
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager512e95a7e1b09_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($i, $this);
    }
    ...
    protected function getSecurity_Firewall_Map_Context_LoginFirewallService()
    {
        ...
        return $this->services['security.firewall.map.context.login_firewall'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.in_memory'), 1 => $this->get('fos_user.user_manager')), 'login_firewall', $b, $this->get('event_dispatcher')), 2 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '512e95a6d74e2', $b), 3 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $this->get('security.http_utils'), 'login_firewall', NULL, NULL, NULL, $b));
    }
     ...
     *
     * @return EntityManager512e95a7e1b09_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager An instance of the doctrine.orm.default_entity_manager service
     */
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'jms_di_extra.doctrine_integration.entity_manager.file' => '/Applications/MAMP/htdocs/Colocall/app/cache/dev/jms_diextra/doctrine/EntityManager_512e95a7e1b09.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager512e95a7e1b09_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
